...
class ControladorPet:
    def __init__(self, controlador_hospede):
        ...
        self.__tela = TelaPet()
        self.__controlador_hospede = controlador_hospede  # referência para encontrar hóspede
    ...
    def remover_pet(self):
        cpf_hospede, nome_pet = self.__tela.seleciona_pet_para_remover()
        hospede = self.__controlador_hospede.buscar_hospede(cpf_hospede)
    ...
    def abre_tela(self):
        opcoes = {
            ...
            2: self.listar_pets,
            3: self.remover_pet,
            0: lambda: self.__tela.mostra_mensagem("Retornando ao menu anterior...")
        }
